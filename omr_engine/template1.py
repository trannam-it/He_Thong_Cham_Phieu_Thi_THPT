...
# ---------------------------------------------------------------------------
# DANH SACH TOA DO Y CHUAN cua 40 marker doc theo CANH PHAI cua phieu
# ---------------------------------------------------------------------------
# Phat hien tu anh mau (PhieuQG.0019.jpg) sau khi warp ve template 1100x1540.
# Cac marker nay duoc dung de TINH CHINH HOMOGRAPHY sau warp lan dau, giup
# loai bo nghieng/skew nho con sot lai. So luong cang nhieu, do chinh xac
# cang cao (least-squares fit voi RANSAC).
#
# X cua tat ca cac marker phai = TEMPLATE_FIDUCIAL_TR[0] = 1036 (canh phai)
TEMPLATE_RIGHT_MARKER_X = 1036
TEMPLATE_RIGHT_MARKER_YS = [
     92.5,  211.5,  240.5,  269.5,  298.5,  327.5,  356.0,  385.5,
    415.0,  444.0,  473.0,  559.5,  589.0,  613.0,  638.5,  664.0,
    688.5,  714.0,  738.5,  764.0,  788.5,  813.5,  920.0,  945.5,
    971.0,  996.0, 1019.5, 1155.0, 1180.5, 1206.0, 1231.0, 1256.0,
    1282.0, 1305.0, 1330.0, 1356.0, 1380.0, 1405.0, 1430.5, 1478.0,
]

# Marker trai chi co 2 (TL va BL goc), nhung 1 marker giua co the xuat hien
TEMPLATE_LEFT_MARKER_X = 54
TEMPLATE_LEFT_MARKER_YS = [92.5, 1478.0]
